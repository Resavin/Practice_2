 ...
 * Original file: /npm/@easepick/bundle@1.1.3/dist/index.umd.js
 *
...
! function(t, e) {
    ...
    class i {
        ...
        getFooterView(t) {
            ...
            s.className = "apply-button unit", s.innerHTML = this.picker.options.locale.apply, i.appendChild(s), e.appendChild(i), this.picker.ui.container.appendChild(e), this.picker.trigger("view", {
                date: t,
                element: e,
                view: "Footer"
            })
    ...
    class n {
        ...
        addInstance(t) {
            ...
            else if ("undefined" != typeof easepick && Object.prototype.hasOwnProperty.call(easepick, t)) {
                const e = new easepick[t];
                e.attach(this.picker), this.instances[e.getName()] = e
            } else if ("undefined" !== this.getPluginFn(t)) {
                const e = new(this.getPluginFn(t));
                e.attach(this.picker), this.instances[e.getName()] = e
            } else console.warn(`easepick: ${t} not found.`)
        }
        removeInstance(t) {
            t in this.instances && this.instances[t].detach(), delete this.instances[t]
        }
        getPluginFn(t) {
    ...
    class s {
        ...
        constructor(t) {
            ...
            this.options = {
                ...
                mode: "open"
            }), this.ui.shadowRoot = this.ui.wrapper.shadowRoot, this.ui.container = document.createElement("div"), this.ui.container.className = "container", this.options.zIndex && (this.ui.container.style.zIndex = String(this.options.zIndex)), this.options.inline && (this.ui.wrapper.style.position = "relative", this.ui.container.classList.add("inline")), this.ui.shadowRoot.appendChild(this.ui.container), this.options.element.after(this.ui.wrapper), this.handleCSS(), this.options.element.addEventListener("click", this.binds.show), this.on("render", this.onRender.bind(this)), this.PluginManager.initialize(), this.parseValues(), "function" == typeof this.options.setup && this.options.setup(this), this.on("click", this.onClick.bind(this)), this.renderAll()
        }
        on(t, e, i = {}) {
        ...
        show(t) {
            ...
            this.ui.container.style.position = "absolute", this.ui.container.style.top = `${i}px`, this.ui.container.style.left = `${n}px`, this.ui.container.classList.add("show"), this.trigger("show", {
                target: e
            })
        }
        hide() {
    ...
    t.AmpPlugin = class extends a {
        ...
        onView(t) {
            this.lockPlugin = this.picker.PluginManager.getInstance("LockPlugin"), this.rangePlugin = this.picker.PluginManager.getInstance("RangePlugin"), this.handleDropdown(t), this.handleResetButton(t)
        }
        handleDropdown(t) {
            const {
                view: i,
        ...
        onAttach() {
            if (!Object.keys(this.options.customPreset).length) {
                ...
                this.options.customLabels.forEach(((t, e) => {
        ...
        onClickApplyButton(t) {
            this.picker.isApplyButton(t) && (1 !== this.picker.datePicked.length || this.options.strict || (this.picker.options.element === this.triggerElement && this.setStartDate(this.picker.datePicked[0]), this.options.elementEnd === this.triggerElement && this.setEndDate(this.picker.datePicked[0])), 2 === this.picker.datePicked.length && this.setDateRange(this.picker.datePicked[0], this.picker.datePicked[1]), this.picker.trigger("select", {
                start: this.picker.getStartDate(),
                end: this.picker.getEndDate()
            }), this.picker.hide())
        }
        ...
        onChange(t) {
            ...
            if (i instanceof HTMLSelectElement && i.classList.contains("time-plugin-custom-input")) {
                ...
                this.picker.options.autoApply ? (this.timePicked[n] = a, this.picker.updateValues()) : this.timePrePicked[n] = a
            }
        }
        onClick(t) {
            const e = t.target;
